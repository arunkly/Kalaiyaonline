...
function LocalPage() {
  ...
  const maxVotes = Math.max(...body.candidates.map((c) => c.votes), 1);
  ...
  return (
    ...
    <div className="min-w-0 space-y-6">
      ...
      <section className="rounded-[1.5rem] bg-white p-5 sm:p-8">
        ...
        <p className="mt-4 font-display text-2xl">{body.winnerName || "नतिजा आउन बाँकी"}</p>
      </section>
      <section className="rounded-[1.5rem] bg-white p-5 sm:p-8">
