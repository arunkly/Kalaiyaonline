  ...
  return (
    <article className="mx-auto max-w-3xl space-y-6 text-base leading-relaxed text-ink-soft">
      ...
      <section className="space-y-2">
        ...
        <p>ती सेवाको आफ्नै गोपनीयता नीति लागु हुन्छ।</p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p>
          ...
          पठाई तापक्रम निकालिन्छ; ठीक ठेगाना संकलन गरिࠖदैन। अनुमति अस्वीकार गरे कलैयाको मौसम
      ...
      <section className="space-y-2">
        ...
        <p>
          ...
          सकिन्छ। अनुमति बिना पुश पठाइࠖदैन।
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p>
          एपमा नयाࠖ सुविधा आए यो पृष्ठ अद्यावधिक हुन्छ। मिति माथिको “अन्तिम अद्यावधिक” मा
          हेर्नुहोस्।
        </p>
      </section>
